...
{
    public class MatchStringInGuild : MatchingPattern
    {
        public bool IgnoreCase { get; private set; }
        public string StringToMatch { get; private set; }
        public bool Contains { get; private set; }

        public ulong GuildOwner { get; private set; }

        public MatchStringInGuild(string stringToMatch, ulong guildOwner, bool ignoreCase = true, bool contains = true)
        {
        ...
        public override bool CheckMatch(SocketMessage message)
        {
            ...
            if (channel.Guild.Id != GuildOwner)
                return false;
